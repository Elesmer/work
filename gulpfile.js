...
gulp.task('build-css', ['sass'], function() {
	return gulp.src([
		'app/css/main.css', // Выбираем файл для минификации
		'app/css/media.css' // Выбираем файл для минификации
])
...
gulp.task('gulp-uncss', function () {
    return gulp.src('app/css/main.css')
        .pipe(uncss({
            html: ['app/index.html', 'app/blog.html']
        }))
...
gulp.task('assets-build', ['gulp-group-css-media-queries', 'build-css', 'build-scripts'], function() {
