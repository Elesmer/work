...
if (document.title == 'Home') {
  ...
  // About us button scroll disable
  $("#js-home-about-us-link").click(function() {
    $.scrollify.disable();
  });

  // About us button scroll enable
...
if (document.title == 'Contacts') {
  ...
  $(".contacts__page-wrapper").mousemove(function(e) {
    parallaxIt(e, ".contacts__bg-img", -50);
  });

  function parallaxIt(e, target, movement) {
    var $this = $(".contacts__page-wrapper");
    ...
    TweenMax.to(target, 2, {
      rotationX: relX / 50,
      x:
      (relX - $this.width() / 1) / $this.width() * movement,

      rotationY: relY / 50,
      y:
      (relY - $this.height() / 1) / $this.height() * movement
    });
  }
