$(document).ready(function() {
  ...
  var rent_c = $('.rent-carousel');
  rent_c.owlCarousel();
  $('.rent-left-nav').click(function() {
    rent_c.trigger('prev.owl.carousel');
  })
  $('.rent-right-nav').click(function() {
    rent_c.trigger('next.owl.carousel', [300]); // в квадратных скобках скорость переключения
  })
